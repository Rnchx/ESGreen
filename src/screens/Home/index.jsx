  ...
  return (
    <View style={styles.container}>
      <ImageBackground style={styles.image} source={require('../../../assets/Design sem nome (1).png')}>
        ...
        <View style={styles.containerEsgMensagem}>
          <Text style={styles.textoEsg}><Text style={styles.textoEsgLetrasMaiuscula}>E</Text>nvironmental</Text>
          <Text style={styles.textoEsg}><Text style={styles.textoEsgLetrasMaiuscula}>S</Text>ocial</Text>
          <Text style={styles.textoEsg}><Text style={styles.textoEsgLetrasMaiuscula}>G</Text>overnance</Text>
        </View>
